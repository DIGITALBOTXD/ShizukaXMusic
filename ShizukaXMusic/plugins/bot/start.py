        ...
        if name[0:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/TEAM_PHYSCO_FIGHTER) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:
...
async def start(client: Client, message: Message):
    await message.reply_photo(
        photo=f"https://telegra.ph//file/a1cb97a46b6c27a050902.jpg",
...
""",
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton("🌼 sʜɪᴢᴜᴋᴀ ᴄʜᴀᴛ 💮", url=f"https://t.me/XD_MUSIC_BOTZ")]]
        ),
    )
